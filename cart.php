...
<head>
	<meta charset="utf-8">
	<title>Afilli e-Market AnaSayfa</title>
	...
	<div class="navbar navbar-default navbar-fixed-top" id="topnav">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="index.php" class="navbar-brand">Afilli e-Market</a>
			</div>
		...
		<div class="row">
			...
			<div class="row">
				...
				<div class="panel panel-primary text-center">
					<div class="panel-heading">Sepet Özeti</div>
					<div class="panel-body"></div>
					<div class="row">
						<div class="col-md-2"><b>Eklenenler</b></div>
						<div class="col-md-2"><b>Ürün Resmi</b></div>
						<div class="col-md-2"><b>Ürün Adı</b></div>
						<div class="col-md-2"><b>Ürün Fiyatı</b></div>
						<div class="col-md-2"><b>Adet</b></div>
						<div class="col-md-2"><b>Fiyat(TL)</b></div>
					</div>
					<br><br>
					<div id='cartdetail'>
					<!--<div class="row">
				...
				<button class='btn btn-success btn-lg pull-right' id='checkout_btn' data-toggle="modal" data-target="#myModal">Ödemeyi Tamamla</button>
			</div>
