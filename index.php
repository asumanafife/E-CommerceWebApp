	...
	<div class="navbar navbar-default navbar-fixed-top" id="topnav">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="index.php" class="navbar-brand">Afilli</a>
			</div>
			...
			<ul class="nav navbar-nav navbar-right">
				<li id='shoppingcart'><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-shopping-cart"></span>Sepet <span class="badge">0</span>	</a>
					...
					<div style="width: 300px;">
						<div class="panel panel-primary">
							...
							<div class="panel-heading">
								...
								<p><br></p>
								<a href="#" style="color: white;list-style-type: none;">Şifrenizi mi unuttunuz?</a>
								<input type="submit" class="btn btn-success" style="float: right;bottom:12px;" id="login" value="Giriş Yap" name="">
							</div>
				...
				<li><a href="customer_registration.php">Kayıt Ol</a></li>
			</ul>
		</div>
	</div>
		<br><br><br>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div id="get_cat"></div>
				...
				<!--<div class="nav nav-pills nav-stacked">
					<li class="active"><a href="#"><h4>Brandss</h4></a></li>
					<li><a href="#">Categories</a></li>
					<li><a href="#">Categories</a></li>
					<li><a href="#">Categories</a></li>
					<li><a href="#">Categories</a></li>
...
<p> Dizayn eden firma: <a href="https://kahvedunyasi.org/">Afilli e-Market</a></p>
</footer></div>
